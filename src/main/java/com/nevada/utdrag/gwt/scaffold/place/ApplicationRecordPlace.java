...
/**
 * A place in the app focused on the {@link Values} of a particular type of {@link com.google.gwt.valuestore.shared.Record Record}.
 */
public abstract class ApplicationRecordPlace extends ApplicationPlace {

	/**
	 * The things you do with a record, each of which is a different bookmarkable location in the scaffold app.
	 */
